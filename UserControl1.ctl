...
Dim DF As POINTAPI
GetCursorPos DF
PlaySound 2, Val(DF.X), Val(DF.Y), Screen.Height / 15, Screen.Width / 15, DSBPLAY_DEFAULT
End Sub
...
Dim DF As POINTAPI
GetCursorPos DF
If UserControl.Picture <> Picture2.Picture Then PlaySound 1, Val(DF.X), Val(DF.Y), Screen.Height / 15, Screen.Width / 15, DSBPLAY_DEFAULT
End If
...
UserControl.Width = 192 * 15
UserControl.Height = 26 * 15
End Sub
